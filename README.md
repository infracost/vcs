...
| `HideDashboardLinks` | `bool` | Drop everything linking to Infracost Cloud: pre-existing issues, usage costs footnote, the governance "view all issues" link and the budget footnote link. |
